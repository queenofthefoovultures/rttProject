...
public class CoordinateConverter {
    ...
    public Vector3 ecef2LocalEnu(Vector3 ecef){
        Gdx.app.log("ecef2LocalEnu","ecef input in ecef2localEnu: " + ecef.x + ", y: " + ecef.y + ", z: " + ecef.z);
    ...
    private void createConverterMatrix(Vector3 ecefCoordinates){
        ...
        Gdx.app.log("ENUMATRIX","ECEFCoordinates x: " + ecefCoordinates.x + ", y: " + ecefCoordinates.y + ", z: " + ecefCoordinates.z);
        ...
        Gdx.app.log("ENUMATRIX","ECEFCpy x: " + -ecefCpy.x + ", y: " + -ecefCpy.y + ", z: " + -ecefCpy.z);
